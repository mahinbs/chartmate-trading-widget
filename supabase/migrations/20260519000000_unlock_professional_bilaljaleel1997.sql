-- Manual entitlement: bilaljaleel1997@gmail.com gets complimentary Professional plan access.
-- AI Trading Analysis is hidden for this account via frontend feature flag only.
...
begin
  ...
  into v_user_id
  from auth.users u
  where lower(u.email) = lower('bilaljaleel1997@gmail.com')
  limit 1;

  if v_user_id is null then
    raise notice 'Manual exception skipped: user bilaljaleel1997@gmail.com not found in auth.users';
    return;
  end if;
