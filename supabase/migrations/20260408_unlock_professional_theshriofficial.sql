...
-- theshriofficial@gmail.com gets complimentary Professional plan access for 3 months.
...
begin
  ...
  into v_user_id
  from auth.users u
  where lower(u.email) = lower('theshriofficial@gmail.com')
  limit 1;

  if v_user_id is null then
    raise notice 'Manual exception skipped: user theshriofficial@gmail.com not found in auth.users';
    return;
  end if;
