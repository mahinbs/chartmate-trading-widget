...
const WorkSlider = () => {
    ...
    const caseStudies = [
        ...
        },
        {
            ...
            description: "While retail sentiment was maximum bullish, ChartMate's sentiment analysis diverged, predicting a top with 94% confidence. This alert helped thousands of traders lock in profits before the 12% correction.",
