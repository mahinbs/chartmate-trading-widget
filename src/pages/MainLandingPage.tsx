  ...
  return (
    <div className="min-h-screen bg-black text-zinc-100 font-sans selection:bg-teal-500/30 selection:text-teal-100 overflow-x-hidden">
      <Helmet>
        ...
        <meta
          name="description"
          content="Connect your trading bot, analyze strategy probability, and test trades safely with advanced AI insights."
        />
      </Helmet>
      ...
      <section
        id="hero"
        className="relative min-h-screen flex items-center justify-center pt-32 pb-20 px-4 overflow-hidden bg-black"
      >
