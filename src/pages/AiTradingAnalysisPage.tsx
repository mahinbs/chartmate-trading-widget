...
const AiTradingAnalysisPage = () => {
  ...
  const { myTenantMembership } = useMyTenantMembership();
  ...
  useEffect(() => {
    if (user) {
      if (myTenantMembership?.status === "active") {
        navigate(`/wl/${myTenantMembership.tenant?.slug}/dashboard`);
      } else if (role === "admin") {
        navigate("/admin");
      } else {
        navigate("/home");
  ...
  }, [user, role, navigate, myTenantMembership]);
  ...
  if (authLoading || roleLoading) return <div className="min-h-screen bg-black" />;
    ...
    <div className="bg-black min-h-screen overflow-x-hidden font-ibm-sans selection:bg-teal-500/30 selection:text-teal-400">
      ...
      <section className="pt-16 md:pt-32 bg-black border-b border-zinc-900">
         <div className="container mx-auto px-4 max-w-6xl pb-8 relative">
            <h2 className="font-bebas text-4xl md:text-5xl text-center text-white mb-10 md:mb-16">PRICING</h2>
            <div className="overflow-x-auto -mx-4 px-4 pb-4 scrollbar-thin scrollbar-thumb-zinc-800">
            
            <table className="min-w-[720px] w-full text-left font-ibm-sans border-collapse relative z-10">
               <thead>
                 <tr className="border-b border-zinc-800">
                   <th className="py-6 px-4 font-normal text-zinc-600 underline decoration-zinc-800 underline-offset-4">FEATURES</th>
                   ...
                   <th className="py-6 px-6 text-center w-1/4 bg-amber-400/[0.03] border-x border-t border-amber-400/20 relative">
                     <div className="absolute -top-3 left-1/2 -translate-x-1/2 font-ibm-mono text-[10px] bg-amber-400 text-black px-3 py-1 font-bold">POPULAR</div>
               ...
               <tbody className="text-zinc-300">
                 ...
                 <tr className="border-b border-zinc-800/50 hover:bg-white/[0.01]">
                   ...
                   <td className="py-5 px-6 text-center font-ibm-mono text-sm bg-amber-400/[0.03] border-x border-amber-400/20 text-amber-200">Scaling Traders</td>
                 ...
                 <tr className="border-b border-zinc-800/50 hover:bg-white/[0.01]">
                   ...
                   <td className="py-5 px-6 text-center font-ibm-mono text-sm bg-amber-400/[0.03] border-x border-amber-400/20 text-amber-200">Up to 3 strategies</td>
                   <td className="py-5 px-6 text-center font-ibm-mono text-sm text-teal-400">Multiple strategies</td>
                 </tr>
                 {/* Row 3 */}
                 <tr className="border-b border-zinc-800/50 hover:bg-white/[0.01]">
                   ...
                   <td className="py-5 px-6 text-center font-ibm-mono text-sm bg-amber-400/[0.03] border-x border-amber-400/20">Advanced reports</td>
                 ...
                 <tr className="border-b border-zinc-800/50 hover:bg-white/[0.01]">
                   ...
                   <td className="py-5 px-6 text-center bg-amber-400/[0.03] border-x border-b border-amber-400/20 font-ibm-mono text-sm">Faster processing</td>
                   <td className="py-5 px-6 text-center font-ibm-mono text-sm text-teal-400">Faster config cycles</td>
                 </tr>
                 {/* Row 6 */}
            ...
            <div className="mt-10 md:mt-16 border-t border-zinc-800 pt-8 md:pt-10 text-center relative z-10">
               ...
               <p className="font-ibm-mono text-xs text-zinc-500">(Depends on complexity of user-defined strategy)</p>
            </div>
         </div>
      </section>
